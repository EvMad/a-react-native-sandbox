...
const FeedbackForm = () => {
   ...
   <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
         <ScrollView keyboardDismissMode="on-drag">
            ...
            <TextInput value={firstName} onChangeText={onChangeFirstName} style={styles.input} clearButtonMode="always" placeholder="first name" />
            <TextInput value={lastName} onChangeText={onChangeLastName} style={styles.input} clearButtonMode="always" placeholder="last name" />
            <TextInput value={phoneNumber} onChangeText={onChangePhoneNumber} style={styles.input} keyboardType={"phone-pad"} clearButtonMode="always" placeholder="phone number" />
